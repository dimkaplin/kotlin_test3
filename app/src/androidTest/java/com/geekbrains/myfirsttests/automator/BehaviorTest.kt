...
class BehaviorTest {
    ...
    fun test_SearchIsPositive() {
        ...
        val editText = uiDevice.findObject(By.res(packageName, "searchEditText"))
        val searchActivityButton = uiDevice.findObject(By.res(packageName, "searchActivityButton"))
        //Устанавливаем значение
        editText.text = "Button"
        //Отправляем запрос через click
        searchActivityButton.click()
        val editText2 = uiDevice.wait(
        ...
        Assert.assertEquals(changedText.text.toString(), "Number of results: 3")
    }
